...
const Input: FC<InputProps> = ({ title, placeholder, require, name, handleChange,type}) => {
    ...
    return (
        <div className='flex flex-col relative bg-white'>
            <span className='bg-white ml-2'>
                <label className='text-lg font-medium absolute -top-2 bg-white leading-none text-secondary flex flex-row space-x-1'>{title} {require ? <p className='text-emergency'>*</p> : ''}</label>
            </span>
